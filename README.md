...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.65-blue.svg)](https://doi.org/10.25663/bl.app.65)

# Dipy Mask

The App generates a mask from reference (like FA/GFA) of your diffusion-weighted magnetic resonance imaging data.
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_mask`](https://dipy.org/documentation/latest/reference_cmd/dipy_mask/) workflow.
